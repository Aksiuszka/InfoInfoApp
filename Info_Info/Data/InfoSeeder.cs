...
using Text = Info_Info.Models.Text;


namespace Info_Info.Data
{
    public class InfoSeeder
    {
        ...
        private static void SeedOpinions(ApplicationDbContext dbContext)
        {
            if (!dbContext.Opinions.Any())
            {
                var idUzytkownika1 = dbContext.AppUsers
                    .Where(u => u.UserName == "autor2@portal.pl").FirstOrDefault().Id;
        ...
        private static void SeedCategoris(ApplicationDbContext dbContext)
        {
            if (!dbContext.Categories.Any())
            {
                ...
                new Category 
                { 
                    Name = "Wiadomości", Active = true,
                    Display=true, Icon="chat-left-text", 
                ...
                new Category 
                { 
                    Name = "Artykuły", Active = true,
                    Display=true, Icon="journal-richtext", 
                ...
                new Category 
                { 
                    Name = "Testy", Active = true,
                    Display=true, Icon="speedometer", 
                ...
                new Category 
                { 
                    Name = "Porady", Active = true,
                    Display=true, Icon="life-preserver", 
                  ...
                  
            {
                ...
                for (int j = 5; j <= 9; j++) //teksty autora2
                {
                    var tekst = new Text()
                    {
                        ...
                        "id est laborum.Sed ut perspiciatis unde omnis iste natus error sit voluptatem 42  accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo " +
                        "inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia " +
                        "consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, " +
